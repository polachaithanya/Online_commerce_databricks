...
dimpurchasecategory_df = purchaseCategoryDf.filter(
    purchaseCategoryDf.RecordId.isNotNull()
).select(
...
dimpurchasecategory_df.write.format("delta").mode("overwrite").saveAsTable("onlinecommerce.silver.dimpurchasecategory")
