...
# Paths
cdm_path = "/Volumes/onlinecommerce/landing/sales_volume/PaymentTypes.cdm.json"
manifest_path = "/Volumes/onlinecommerce/landing/sales_volume/Sales.manifest.cdm.json"
csv_path = "dbfs:/Volumes/onlinecommerce/landing/sales_volume/PaymentTypes/*.csv"
...
df.write.format("delta").mode("overwrite").saveAsTable("onlinecommerce.bronze.paymenttypes")
